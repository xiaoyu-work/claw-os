...
cos proc spawn --tier 1 --scope /home/cos/project --session builder-1 -- build.py
cos proc spawn --tier 2 --scope /home/cos/output --parent lead --session writer-1 -- report.py
```
