...
const initialNodes: FSNode[] = [
  ...
  // Sample files
  { id: 'fs-readme', name: 'README.txt', type: 'file', parentId: 'fs-user', content: 'Welcome to the Claw OS Demo!\n\nExplore the first-party desktop apps and the built-in system Agent.\n\n- Double-click icons to open apps\n- Open Claw OS Agent for guided system tasks\n- Open Claw OS Website to explore the full vision\n', permissions: '-rw-r--r--', owner: 'user', size: 226, mimeType: 'text/plain', createdAt: now, modifiedAt: now },
  { id: 'fs-motd', name: 'motd', type: 'file', parentId: 'fs-etc', content: 'Claw OS Demo\n\nThe browser demo is ready.\nSystem Agent: available\nApp permissions: capability scoped\n', permissions: '-rw-r--r--', owner: 'root', size: 105, mimeType: 'text/plain', createdAt: now, modifiedAt: now },
  ...
  { id: 'fs-notes', name: 'notes.txt', type: 'file', parentId: 'fs-user-doc', content: 'Claw OS Demo Notes:\n- Ask the Agent about system health\n- Inspect app permissions\n- Try a cross-app workflow\n', permissions: '-rw-r--r--', owner: 'user', size: 106, mimeType: 'text/plain', createdAt: now, modifiedAt: now },
