...
cosmic-applet-audio-keywords = Μικροεφαρμογή;Ήχος;ClawOS;Applet;Sound;Audio;MPRIS;
cosmic-applet-bluetooth-keywords = Μικροεφαρμογή;ClawOS;Applet;Bluetooth;
cosmic-applet-input-sources = Πηγές εισόδου
cosmic-applet-input-sources-comment = Εναλλαγή μεταξύ πηγών εισόδου
cosmic-applet-input-sources-keywords = Μικροεφαρμογή;Πηγή;Είσοδος;ClawOS;Applet;Input;Source;
cosmic-applet-minimize-keywords = Μικροεφαρμογή;Ελαχιστοποίηση;ClawOS;Applet;Minimize;
cosmic-applet-network-keywords = Μικροεφαρμογή;Δίκτυο;ClawOS;Applet;Network;
...
cosmic-applet-notifications-keywords = Μικροεφαρμογή;Ειδοποίηση;ClawOS;Applet;Notification;
...
cosmic-applet-power-keywords = Μικροεφαρμογή;Χρήστης;Συνεδρία;Κλείδωμα;Αποσύνδεση;Επανεκκίνηση;Τερματισμός;Αναστολή;ClawOS;Applet;User;Session;Lock;Log;Reboot;Shutdown;Suspend;
cosmic-applet-status-area = Περιοχή ειδοποιήσεων
cosmic-applet-workspaces-keywords = Μικροεφαρμογή;Χώρος;Εργασίας;ClawOS;Applet;Workspace;
cosmic-panel-app-button = Κουμπί βιβλιοθήκης εφαρμογών
cosmic-panel-workspaces-button-keywords = Μικροεφαρμογή;Χώρος;Εργασίας;Επισκόπηση;ClawOS;Applet;Workspace;Overview;
cosmic-app-list-keywords = Μικροεφαρμογή;Εφαρμογή;Περιοχή;Λίστα;Εργασία;Γραμμή;ClawOS;Applet;App;Tray;List;Task;Bar;
cosmic-applet-a11y-keywords = Μικροεφαρμογή;Προσβασιμότητα;Προσιτότητα;Οθόνη;Ανάγνωση;Αναγνώστης;Μεγεθυντικός;Φακός;Αντίθεση;Χρώμα;ClawOS;Applet;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;
...
cosmic-applet-battery-keywords = Μικροεφαρμογή;Ενέργεια;Ισχύς;Μπαταρία;ClawOS;Applet;Power;Battery;
cosmic-applet-status-area-keywords = Μικροεφαρμογή;Εφαρμογή;Ένδειξη;Ειδοποίηση;Περιοχή;Κατάσταση;ClawOS;Applet;App;Indicator;Notification;Tray;Status;
cosmic-applet-time-keywords = Μικροεφαρμογή;Ημερομηνία;Ώρα;Ημερολόγιο;ClawOS;Applet;Date;Time;Calendar;
cosmic-panel-app-button-comment = Άνοιγμα της βιβλιοθήκης εφαρμογών για εκκίνηση εγκατεστημένων εφαρμογών
cosmic-panel-app-button-keywords = Μικροεφαρμογή;Εφαρμογή;Βιβλιοθήκη;Περιοχή;ClawOS;Applet;App;Library;Tray;
...
cosmic-applet-tiling-keywords = Μικροεφαρμογή;Παράθεση;Ένδειξη;Χώρος;Εργασίας;ClawOS;Applet;Tiling;Hint;Workspace;
...
cosmic-panel-launcher-button-keywords = Μικροεφαρμογή;Μενού;Εκκίνηση;Εκτέλεση;ClawOS;Applet;Launcher;Runner;
