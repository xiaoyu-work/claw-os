...
cosmic-applet-agent-activity = Agent Activity
cosmic-applet-agent-activity-comment = Live timeline of running and paused Claw OS agent tasks
cosmic-applet-agent-activity-keywords = ClawOS;Applet;Agent;Tasks;Sessions;
cosmic-applet-approval-gate = Approval Gate
cosmic-applet-approval-gate-comment = Approve or deny live capability requests from the panel
cosmic-applet-approval-gate-keywords = ClawOS;Applet;Approval;Permissions;Capabilities;Security;
