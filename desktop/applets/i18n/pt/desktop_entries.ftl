...
cosmic-applet-tiling-keywords = ClawOS;Miniaplicação;Applet;Agrupamento;Sugestão;Área;Trabalho;
cosmic-applet-workspaces-comment = Alternar entre áreas de trabalho numeradas no painel
cosmic-applet-workspaces-keywords = ClawOS;Miniaplicação;Applet;Área;Trabalho;
cosmic-panel-workspaces-button-comment = Abrir a visão geral das áreas de trabalho para gerir e alternar entre elas
cosmic-panel-workspaces-button-keywords = ClawOS;Miniaplicação;Applet;Área;Trabalho;Visão;Geral;
