//! Thin desktop-side glue around [`claw_bridge`] so the COSMIC App
...
use claw_bridge::{BridgeError, call, exec, fs as bridge_fs};
...
///
/// [`claw_bridge::fs::read`] can't be used here because that verb is
