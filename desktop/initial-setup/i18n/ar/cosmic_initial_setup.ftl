...
new-apps-page = تطبيقات النظام الجديدة
    .description = استمتع بمجموعة من تطبيقات النظام الجديدة التي تأتي مع بيئة سطح المكتب ClawOS. بما في ذلك الإعدادات ومتجر تطبيقات ClawOS والملفات ومحرِّر النصوص والطرفية.
