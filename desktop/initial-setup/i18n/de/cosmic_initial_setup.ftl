...
new-apps-page = Neue Systemanwendungen
    .description = Erfreue dich an einer Reihe neuer Systemanwendungen, die mit der ClawOS Desktopumgebung kommen. Dazu gehören die Einstellungen, der ClawOS App Store, Dateien, Texteditor und Terminal.
