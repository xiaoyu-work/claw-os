...
`browser-attached`, `exec`, `container-manager`, `backup-center`, the Browser
extension/Native Host and Mail UI/native source are owned there already. Do not recreate a
