...
| App execution from a leased Agent task | `core/src/agentd/app_host/`, `core/src/clawd/app_sessions/task_host.rs` | Original invocation retention, normal App authority, broker admission, runtime provenance, sandbox, cancellation and receipt capture; no general broker access |
