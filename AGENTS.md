...
| Agent terminal frontend | `core/src/agent/terminal/`, `docs/agent-terminal.md` | Claw-owned ratatui renderer, canonical `clawd/conversations.rs`, broker task/approval streams, plain chat compatibility; external TUI binaries and compatibility protocols are not runtime dependencies |
