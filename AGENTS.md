...
| Agent terminal frontend | `core/src/agent/terminal/`, `docs/agent-terminal.md` | Claw-owned ratatui renderer, canonical conversations/tasks/approvals/Activities, broker-owned workspace contract, plain chat compatibility; external TUI binaries and compatibility protocols are not runtime dependencies |
