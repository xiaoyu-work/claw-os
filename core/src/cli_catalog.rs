    ...
    vec![
        ...
        (
            ...
            vec![
                ...
                ("monetary-budget", "Read policy-priced USD accounting and durable reservations"),
                ("set-monetary-budget", "Set bounded USD micro-unit rates, total, and per-turn output cap"),
                ("enable-monetary-budget", "Enable an existing Activity monetary budget at its revision"),
                ("disable-monetary-budget", "Block new model turns without deleting monetary accounting"),
