...
- Public command selection preserves explicit operation precedence; otherwise
  the exact App-prefixed MCP tool supplies arguments, needs and effects.
  MCP-only Apps do not require a legacy operation or executable fallback.
