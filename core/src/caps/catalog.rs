...
pub const CATALOG: &[CapMeta] = &[
    ...
    CapMeta::new(
        Verb::SYS_LOCALE,
        ScopeKind::Name,
        LocalizedStr::new("Change system language and regional formats"),
        LocalizedStr::new("Set system locale defaults through the OS locale service. Requires the exact system name scope; no file or account authority."),
        "🌐",
        Risk::High,
    ),
    CapMeta::new(
        Verb::SYS_LANGUAGE,
        ScopeKind::Name,
        LocalizedStr::new("Change your preferred languages"),
        LocalizedStr::new("Set only the authenticated owner's AccountsService language preference. Requires the exact self name scope; no other account administration."),
        "🌐",
        Risk::Medium,
    ),
    CapMeta::new(
        Verb::SYS_HOSTNAME,
        ScopeKind::Name,
        LocalizedStr::new("Change the computer name"),
        LocalizedStr::new("Set the static system hostname through the OS hostname service. Requires the exact static name scope; no general system configuration authority."),
        "💻",
        Risk::High,
    ),
    CapMeta::new(
    ...
    CapMeta::new(
        Verb::CLIPBOARD_READ,
        ScopeKind::Name,
        LocalizedStr::new("Read clipboard content"),
        LocalizedStr::new(
            "Read potentially sensitive data from the named clipboard selection or history store.",
        ),
        "📋",
        Risk::High,
    ),
    CapMeta::new(
        ...
        ScopeKind::Name,
        LocalizedStr::new("Modify clipboard content"),
        LocalizedStr::new(
            "Replace, restore, delete, or clear data in the named clipboard selection or history store.",
        ),
        "✂️",
        Risk::High,
    ),
