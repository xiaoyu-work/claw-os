...
fn builtin_apps() -> Vec<(
    ...
    vec![
        ...
        ("agent", "OS-native agent subsystem — runtime, memory, skills, LLM providers, tools (Phase 0 skeleton)", vec![
            ...
            ("skills", "Inspect or install skill bundles: cos agent skills [list|info <id>|disabled|errors|root|install <archive.zip> [--force]|hub <list|show|install> <owner/repo> [<id>]]"),
