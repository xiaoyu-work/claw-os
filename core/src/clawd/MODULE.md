...
| `conversations.rs`, `conversations/` | Owner-scoped Agent conversation create/get/list/update, stable frontend UUID projection, verified task/message annotations, bounded actual Job metadata, and owner-identity memory reads; no task execution or authority |
