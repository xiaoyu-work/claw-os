...
| `conversations.rs`, `conversations/` | Owner-scoped Agent conversation create/get/list/update/fork, stable frontend UUID projection, verified task/message annotations, bounded actual Job metadata, and owner-identity snapshot copies; no task execution or authority |
