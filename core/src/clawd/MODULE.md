...
| `desktop.rs` | Owner desktop service; native Files can reveal one local file/directory only in `com.clawos.Files`, with exact metadata and launch capabilities |
