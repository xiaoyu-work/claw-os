...
socket paths. For configured Agent extensions it also signs owner-qualified
package verification receipts, including exact package/signer/trust-generation
bindings. The host accepts
