...
| `app_sources.py --native` | Validate and refresh product-declared native libraries/assets (Calendar, Clipboard, Widget Rail) and standalone Launcher/Editor/Files/Terminal at stable ignored build paths from the immutable pin |
